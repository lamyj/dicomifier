...
#ifndef _c96e0eb1_f434_4491_9d1c_c17fb9904c44
#define _c96e0eb1_f434_4491_9d1c_c17fb9904c44
 ...
 *
 * This class is a copy of DCMTK DicomDirInterface that allows extra attributes
 * to be inserted at the Patient, Study or Series level. Since the
 * DicomDirInterface class is not meant for inheritance (buildXXXRecord are
 * non-virtual and DicomDir is private), the whole class must be re-coded.
 */
class DicomDirGenerator
{
  ...
  public:
    ...
    std::vector<DcmTagKey> const & getPatientExtraAttributes() const;
    void setPatientExtraAttributes(std::vector<DcmTagKey> const & attributes);

    std::vector<DcmTagKey> const & getStudyExtraAttributes() const;
    void setStudyExtraAttributes(std::vector<DcmTagKey> const & attributes);

    std::vector<DcmTagKey> const & getSeriesExtraAttributes() const;
    void setSeriesExtraAttributes(std::vector<DcmTagKey> const & attributes);
  ...
  private:
    ...
    std::vector<DcmTagKey> _patient_extra_attributes;
    std::vector<DcmTagKey> _study_extra_attributes;
    std::vector<DcmTagKey> _series_extra_attributes;

    /// private undefined copy constructor
    DicomDirGenerator(const DicomDirInterface &obj);

    /// private undefined assignment operator
    DicomDirGenerator &operator=(const DicomDirInterface &obj);
};

} // namespace dicomifier

#endif // _c96e0eb1_f434_4491_9d1c_c17fb9904c44
