...
#need here to have the first arg dicom_data_sets in odil format instead of JSON 
def convert(dicom_data_sets, dtype):
	...
	series_instance_uid = odil_getter._getter(data_sets[0],odil.registry.SeriesInstanceUID)[0]
...
def _get_splitters(data_sets):
    ...
    splitters = {
        "ALL": [
            ...
            (odil.registry.ImageOrientationPatient, odil_getter.OrientationGetter()),
