...
_module.PlaneOrientationPatient = function(indexGenerator, 
                                           dicomSequenceItem, 
                                           brukerDataset) {
    ...
    if (indexOrentation !== null) {
        beginIndex = indexOrentation[1] + 
                     indexGenerator.currentIndex[indexOrentation[0]] * 9;
    }
    var value = 
        brukerDataset['VisuCoreOrientation'].slice(beginIndex, 
                                                   beginIndex + 6);
