...
- Extract diffusion data from NIfTI+JSON: ``dicomifier diffusion-scheme meta_data_file mrtrix diffusion.scheme`` or ``dicomifier diffusion-scheme meta_data_file fsl diffusion.bvecs diffusion.bvals``
