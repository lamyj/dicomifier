...
BOOST_AUTO_TEST_CASE(Constructor)
{
    ...
    auto testfieldus = dicomifier::translator::
            SpacingBetweenSlicesDcmField<EVR_US>::New();
    // Pointer exists
    BOOST_CHECK(testfieldus != NULL);
    
    // Test VR = UT
    auto testfieldut = dicomifier::translator::
            SpacingBetweenSlicesDcmField<EVR_UT>::New();
    // Pointer exists
...
struct TestDataOK02
{
    ...
    TestDataOK02() : filename("./tmp_test_ModuleSpacingBetweenSlicesDcmField")
    {
        std::ofstream myfile;
