...
BOOST_AUTO_TEST_CASE(Constructor)
{
    ...
    auto testfieldus = dicomifier::translator::
            ImageOrientationPatientDcmField<EVR_US>::New();
    // Pointer exists
    BOOST_CHECK(testfieldus != NULL);
    
    // Test VR = UT
    auto testfieldut = dicomifier::translator::
            ImageOrientationPatientDcmField<EVR_UT>::New();
    // Pointer exists
...
struct TestDataOK02
{
    ...
    TestDataOK02() : filename("./tmp_test_ModuleImageOrientationPatientDcmField")
    {
        std::ofstream myfile;
...
struct TestDataOK03
{
    ...
    TestDataOK03() : filename("./tmp_test_ModuleImageOrientationPatientDcmField")
    {
        std::ofstream myfile;
        myfile.open(filename);
        myfile << "##TITLE=tmp_test_brukerfieldmodule\n";
