...
BOOST_AUTO_TEST_CASE(TEST_OK_01)
{
    ...
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldae->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = AS
    auto testfieldas = dicomifier::translator::InStackPositionNumberDcmField<EVR_AS>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldas->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = AT
    auto testfieldat = dicomifier::translator::InStackPositionNumberDcmField<EVR_AT>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldat->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = CS
    auto testfieldcs = dicomifier::translator::InStackPositionNumberDcmField<EVR_CS>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldcs->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = DA
    auto testfieldda = dicomifier::translator::InStackPositionNumberDcmField<EVR_DA>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldda->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = DS
    auto testfieldds = dicomifier::translator::InStackPositionNumberDcmField<EVR_DS>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldds->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = DT
    auto testfielddt = dicomifier::translator::InStackPositionNumberDcmField<EVR_DT>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfielddt->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = FL
    auto testfieldfl = dicomifier::translator::InStackPositionNumberDcmField<EVR_FL>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldfl->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = FD
    auto testfieldfd = dicomifier::translator::InStackPositionNumberDcmField<EVR_FD>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldfd->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = IS
    auto testfieldis = dicomifier::translator::InStackPositionNumberDcmField<EVR_IS>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldis->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = LO
    auto testfieldlo = dicomifier::translator::InStackPositionNumberDcmField<EVR_LO>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldlo->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = LT
    auto testfieldlt = dicomifier::translator::InStackPositionNumberDcmField<EVR_LT>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldlt->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);
    ...
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldpn->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = SH
    auto testfieldsh = dicomifier::translator::InStackPositionNumberDcmField<EVR_SH>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldsh->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = SL
    auto testfieldsl = dicomifier::translator::InStackPositionNumberDcmField<EVR_SL>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldsl->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);
    ...
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldss->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = ST
    auto testfieldst = dicomifier::translator::InStackPositionNumberDcmField<EVR_ST>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldst->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = TM
    auto testfieldtm = dicomifier::translator::InStackPositionNumberDcmField<EVR_TM>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldtm->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = UI
    auto testfieldui = dicomifier::translator::InStackPositionNumberDcmField<EVR_UI>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldui->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = UL
    auto testfieldul = dicomifier::translator::InStackPositionNumberDcmField<EVR_UL>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldul->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);
    ...
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldus->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);

    // Test VR = UT
    auto testfieldut = dicomifier::translator::InStackPositionNumberDcmField<EVR_UT>::New();
    // Pointer exists and class type is InStackPositionNumberDcmField
    BOOST_CHECK_EQUAL(testfieldut->get_class_type(), dicomifier::translator::ECT_InStackPositionNumberDcmField);
}
