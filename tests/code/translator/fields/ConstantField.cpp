...
BOOST_AUTO_TEST_CASE(TEST_OK_01)
{
    ...
    // Test VR = AT
    auto testfieldat = dicomifier::translator::ConstantField<EVR_AT>::New();
    // Pointer exists
