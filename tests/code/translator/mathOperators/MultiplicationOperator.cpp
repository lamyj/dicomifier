...
BOOST_AUTO_TEST_CASE(TEST_OK_02)
{
    ...
    BOOST_REQUIRE_THROW(multiplicationoperatorae->run(NULL, dicomifier::FrameIndexGenerator({}), NULL), dicomifier::DicomifierException);
}
...
BOOST_AUTO_TEST_CASE(TEST_OK_03)
{
    ...
    BOOST_REQUIRE_THROW(multiplicationoperatoras->run(NULL, dicomifier::FrameIndexGenerator({}), NULL), dicomifier::DicomifierException);
}
...
BOOST_AUTO_TEST_CASE(TEST_OK_04)
{
    ...
    BOOST_REQUIRE_THROW(multiplicationoperatorcs->run(NULL, dicomifier::FrameIndexGenerator({}), NULL), dicomifier::DicomifierException);
}
...
BOOST_AUTO_TEST_CASE(TEST_OK_05)
{
    ...
    BOOST_REQUIRE_THROW(multiplicationoperatorda->run(NULL, dicomifier::FrameIndexGenerator({}), NULL), dicomifier::DicomifierException);
}
...
BOOST_AUTO_TEST_CASE(TEST_OK_06)
{
    ...
    multiplicationoperatords->run(NULL, dicomifier::FrameIndexGenerator({}), NULL);
...
BOOST_AUTO_TEST_CASE(TEST_OK_08)
{
    ...
    multiplicationoperatorcs->run(NULL, dicomifier::FrameIndexGenerator({}), NULL);
...
BOOST_AUTO_TEST_CASE(TEST_OK_13)
{
    ...
    BOOST_REQUIRE_THROW(multiplicationoperatorpn->run(NULL, dicomifier::FrameIndexGenerator({}), NULL), dicomifier::DicomifierException);
}
...
BOOST_AUTO_TEST_CASE(TEST_OK_22)
{
    ...
    BOOST_REQUIRE_THROW(multiplicationoperatorcs->run(NULL, dicomifier::FrameIndexGenerator({}), NULL), 
...
BOOST_AUTO_TEST_CASE(TEST_KO_01)
{
    ...
    BOOST_REQUIRE_THROW(multiplicationoperatords->run(NULL, dicomifier::FrameIndexGenerator({}), NULL), 
                        dicomifier::DicomifierException);
}
