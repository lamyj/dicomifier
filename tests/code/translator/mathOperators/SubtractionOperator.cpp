...
BOOST_AUTO_TEST_CASE(TEST_OK_02)
{
    ...
    subtractionoperatorae->run(NULL, dicomifier::FrameIndexGenerator({}), NULL);
...
BOOST_AUTO_TEST_CASE(TEST_OK_03)
{
    ...
    subtractionoperatoras->run(NULL, dicomifier::FrameIndexGenerator({}), NULL);
...
BOOST_AUTO_TEST_CASE(TEST_OK_04)
{
    ...
    subtractionoperatorcs->run(NULL, dicomifier::FrameIndexGenerator({}), NULL);
...
BOOST_AUTO_TEST_CASE(TEST_OK_05)
{
    ...
    subtractionoperatorda->run(NULL, dicomifier::FrameIndexGenerator({}), NULL);
...
BOOST_AUTO_TEST_CASE(TEST_OK_06)
{
    ...
    subtractionoperatords->run(NULL, dicomifier::FrameIndexGenerator({}), NULL);
...
BOOST_AUTO_TEST_CASE(TEST_KO_01)
{
    ...
    BOOST_REQUIRE_THROW(subtractionoperatords->run(NULL, dicomifier::FrameIndexGenerator({}), NULL), 
