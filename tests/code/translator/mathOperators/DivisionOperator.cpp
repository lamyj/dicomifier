...
BOOST_AUTO_TEST_CASE(TEST_OK_02)
{
    ...
    BOOST_REQUIRE_THROW(divisionoperatorae->run(NULL, dicomifier::FrameIndexGenerator({}), NULL), 
...
BOOST_AUTO_TEST_CASE(TEST_OK_03)
{
    ...
    BOOST_REQUIRE_THROW(divisionoperatoras->run(NULL, dicomifier::FrameIndexGenerator({}), NULL), 
                        dicomifier::DicomifierException);
}
...
BOOST_AUTO_TEST_CASE(TEST_OK_04)
{
    ...
    BOOST_REQUIRE_THROW(divisionoperatorcs->run(NULL, dicomifier::FrameIndexGenerator({}), NULL), 
                        dicomifier::DicomifierException);
}
...
BOOST_AUTO_TEST_CASE(TEST_OK_05)
{
    ...
    BOOST_REQUIRE_THROW(divisionoperatorda->run(NULL, dicomifier::FrameIndexGenerator({}), NULL), 
                        dicomifier::DicomifierException);
}
...
BOOST_AUTO_TEST_CASE(TEST_OK_06)
{
    ...
    divisionoperatords->run(NULL, dicomifier::FrameIndexGenerator({}), NULL);
...
BOOST_AUTO_TEST_CASE(TEST_OK_08)
{
    ...
    divisionoperatorcs->run(NULL, dicomifier::FrameIndexGenerator({}), NULL);
...
BOOST_AUTO_TEST_CASE(TEST_OK_13)
{
    ...
    BOOST_REQUIRE_THROW(divisionoperatorpn->run(NULL, dicomifier::FrameIndexGenerator({}), NULL), 
                        dicomifier::DicomifierException);
}
...
BOOST_AUTO_TEST_CASE(TEST_KO_01)
{
    ...
    BOOST_REQUIRE_THROW(divisionoperatords->run(NULL, dicomifier::FrameIndexGenerator({}), NULL), 
                        dicomifier::DicomifierException);
}
