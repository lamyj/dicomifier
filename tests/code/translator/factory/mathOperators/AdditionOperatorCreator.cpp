...
struct TestDataKO01
{
    ...
    TestDataKO01()
    {
        ...
        ptr.add_child("AdditionOperator", emptynode);
    }
...
{
    auto additionoperatorcreator = dicomifier::translator::
        factory::AdditionOperatorCreator::New();
    
    BOOST_FOREACH(boost::property_tree::ptree::value_type &v, ptr)
    {
        BOOST_REQUIRE_THROW(additionoperatorcreator->Create(v, NULL, EVR_SQ), 
