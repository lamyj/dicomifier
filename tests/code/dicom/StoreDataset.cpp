...
{
    auto storeds = dicomifier::StoreDataset::New();
    BOOST_REQUIRE(storeds != NULL);

    storeds = dicomifier::StoreDataset::New(NULL, "", 0, "", "");
    BOOST_REQUIRE(storeds != NULL);
}
...
BOOST_AUTO_TEST_CASE(Accessors)
{
    ...
    storeds = dicomifier::StoreDataset::New(&dataset,
                                                     "MyAdress",
                                                     11112,
                                                     "REMOTE",
                                                     "LOCAL");
...
BOOST_FIXTURE_TEST_CASE(TEST_OK_03, DcmQrSCP)
{
    ...
    auto teststore = dicomifier::StoreDataset::New();
