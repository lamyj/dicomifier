...
BOOST_AUTO_TEST_CASE(SetAE01)
{
    ...
    OFCondition const condition =
            dataset.findAndGetOFStringArray(DCM_PerformedStationAETitle, str);
    BOOST_CHECK(condition.good());
    BOOST_CHECK_EQUAL(str, "AB");
}

BOOST_AUTO_TEST_CASE(SetAE02)
{
    std::vector<dicomifier::TagAndRange> vect;
    ...
    OFString str;
    OFCondition const condition =
            dataset.findAndGetOFStringArray(DCM_RetrieveAETitle, str);
    BOOST_CHECK(condition.good());
...
BOOST_AUTO_TEST_CASE(SetAS01)
{
    ...
    BOOST_CHECK(cond.good());
    BOOST_CHECK_EQUAL(str, "42Y");
}

BOOST_AUTO_TEST_CASE(SetAS02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_PatientAge,
                                           dicomifier::Range(0,2)));
...
BOOST_AUTO_TEST_CASE(SetCS02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_SelectorCSValue,
                                           dicomifier::Range(0,2)));
    ...
    OFString str;
    OFCondition cond = dataset.findAndGetOFStringArray(DCM_SelectorCSValue,
                                                       str);
    BOOST_CHECK(cond.good());
    BOOST_CHECK_EQUAL(str, "AB\\CD");
}
...
BOOST_AUTO_TEST_CASE(SetDA02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_DateOfLastCalibration,
                                           dicomifier::Range(0,2)));
    ...
    OFString str;
    OFCondition cond =
            dataset.findAndGetOFStringArray(DCM_DateOfLastCalibration, str);
    BOOST_CHECK(cond.good());
...
BOOST_AUTO_TEST_CASE(SetDS01)
{
    ...
    OFString str;
    OFCondition cond = dataset.findAndGetOFStringArray(DCM_PatientWeight,
                                                       str);
    BOOST_CHECK(cond.good());
    BOOST_CHECK_EQUAL(str, "75.57");
}

BOOST_AUTO_TEST_CASE(SetDS02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_EventElapsedTimes,
                                           dicomifier::Range(0,2)));
    ...
    OFString str;
    OFCondition cond = dataset.findAndGetOFStringArray(DCM_EventElapsedTimes,
                                                       str);
    BOOST_CHECK(cond.good());
...
BOOST_AUTO_TEST_CASE(SetDT01)
{
    ...
    OFString str;
    OFCondition cond = dataset.findAndGetOFStringArray(DCM_AcquisitionDateTime,
                                                       str);
    BOOST_CHECK(cond.good());
    BOOST_CHECK_EQUAL(str, "01234501122012");
}

BOOST_AUTO_TEST_CASE(SetDT02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_AcquisitionDateTime,
                                           dicomifier::Range(0,2)));
...
BOOST_AUTO_TEST_CASE(SetFD01)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_SteeringAngle,
                                           dicomifier::Range(0,1)));
...
BOOST_AUTO_TEST_CASE(SetFD02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_SelectorFDValue,
                                           dicomifier::Range(0,2)));
...
BOOST_AUTO_TEST_CASE(SetFL02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_SelectorFLValue,
                                           dicomifier::Range(0,2)));
...
BOOST_AUTO_TEST_CASE(SetIS02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_SelectorISValue,
                                           dicomifier::Range(0,2)));
    ...
    OFString str;
    OFCondition cond = dataset.findAndGetOFStringArray(DCM_SelectorISValue,
                                                       str);
    BOOST_CHECK(cond.good());
...
BOOST_AUTO_TEST_CASE(SetLO02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_AdmittingDiagnosesDescription,
                                           dicomifier::Range(0,2)));
    ...
    OFString str;
    OFCondition cond =
            dataset.findAndGetOFStringArray(DCM_AdmittingDiagnosesDescription,
                                            str);
    BOOST_CHECK(cond.good());
    BOOST_CHECK_EQUAL(str, "AB\\CD");
}
...
BOOST_AUTO_TEST_CASE(SetLT01)
{
    ...
    OFString str;
    OFCondition cond =
            dataset.findAndGetOFStringArray(DCM_AdditionalPatientHistory, str);
    BOOST_CHECK(cond.good());
    BOOST_CHECK_EQUAL(str, "ABCD");
}

BOOST_AUTO_TEST_CASE(SetLT02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_AdditionalPatientHistory,
                                           dicomifier::Range(0,2)));
...
BOOST_AUTO_TEST_CASE(SetPN02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_PhysiciansOfRecord,
                                           dicomifier::Range(0,2)));
    ...
    OFString str;
    OFCondition cond =
            dataset.findAndGetOFStringArray(DCM_PhysiciansOfRecord, str);
    BOOST_CHECK(cond.good());
    BOOST_CHECK_EQUAL(str, "AB\\CD");
}
...
BOOST_AUTO_TEST_CASE(SetSH01)
{
    ...
    OFString str;
    OFCondition cond =
            dataset.findAndGetOFStringArray(DCM_AccessionNumber, str);
    BOOST_CHECK(cond.good());
    BOOST_CHECK_EQUAL(str, "12345");
}

BOOST_AUTO_TEST_CASE(SetSH02)
{
    std::vector<dicomifier::TagAndRange> vect;
    ...
    OFString str;
    OFCondition cond = dataset.findAndGetOFStringArray(
                    DCM_ReferringPhysicianTelephoneNumbers, str);
    BOOST_CHECK(cond.good());
...
BOOST_AUTO_TEST_CASE(SetSL01)
{
    ...
    OFString str;
    OFCondition cond = dataset.findAndGetOFStringArray(DCM_ReferencePixelX0,
                                                       str);
    BOOST_CHECK(cond.good());
    BOOST_CHECK_EQUAL(str, "-123456789");
}

BOOST_AUTO_TEST_CASE(SetSL02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_SelectorSLValue,
                                           dicomifier::Range(0,2)));
...
BOOST_AUTO_TEST_CASE(SetSQ01)
{
    ...
    OFString str;
    condition = dataset.findAndGetOFStringArray(DCM_PatientID, str, true);
    BOOST_CHECK(condition.good());
...
BOOST_AUTO_TEST_CASE(SetSS01)
{
    ...
    OFString str;
    OFCondition cond =
            dataset.findAndGetOFStringArray(DCM_TagAngleSecondAxis, str);
    BOOST_CHECK(cond.good());
    BOOST_CHECK_EQUAL(str, "-123");
}

BOOST_AUTO_TEST_CASE(SetSS02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_SelectorSSValue,
                                           dicomifier::Range(0,2)));
    ...
    OFString str;
    OFCondition cond = dataset.findAndGetOFStringArray(DCM_SelectorSSValue,
                                                       str);
    BOOST_CHECK(cond.good());
...
BOOST_AUTO_TEST_CASE(SetUI02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_SOPClassesInStudy,
                                           dicomifier::Range(0,2)));
    ...
    OFString str;
    OFCondition cond = dataset.findAndGetOFStringArray(DCM_SOPClassesInStudy,
                                                       str);
    BOOST_CHECK(cond.good());
    BOOST_CHECK_EQUAL(str, "1234\\5678");
}
...
BOOST_AUTO_TEST_CASE(SetTM02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_TimeOfLastCalibration,
                                           dicomifier::Range(0,2)));
    ...
    OFString str;
    OFCondition cond =
            dataset.findAndGetOFStringArray(DCM_TimeOfLastCalibration, str);
    BOOST_CHECK(cond.good());
...
BOOST_AUTO_TEST_CASE(SetST01)
{
    ...
    OFString str;
    OFCondition cond = dataset.findAndGetOFStringArray(DCM_InstitutionAddress,
                                                       str);
    BOOST_CHECK(cond.good());
    BOOST_CHECK_EQUAL(str, "abcde");
}

BOOST_AUTO_TEST_CASE(SetST02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_InstitutionAddress,
                                           dicomifier::Range(0,2)));
...
BOOST_AUTO_TEST_CASE(SetUL02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_SelectorULValue,
                                           dicomifier::Range(0,2)));
    ...
    OFString str;
    OFCondition cond = dataset.findAndGetOFStringArray(DCM_SelectorULValue,
                                                       str);
    BOOST_CHECK(cond.good());
...
BOOST_AUTO_TEST_CASE(SetUS01)
{
    ...
    OFString str;
    OFCondition cond =
            dataset.findAndGetOFStringArray(DCM_FailureReason, str);
    BOOST_CHECK(cond.good());
    BOOST_CHECK_EQUAL(str, "456");
}

BOOST_AUTO_TEST_CASE(SetUS02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_SelectorUSValue,
                                           dicomifier::Range(0,2)));
    ...
    OFString str;
    OFCondition cond = dataset.findAndGetOFStringArray(DCM_SelectorUSValue,
                                                       str);
    BOOST_CHECK(cond.good());
...
BOOST_AUTO_TEST_CASE(SetUT01)
{
    ...
    OFString str;
    OFCondition cond =
            dataset.findAndGetOFStringArray(DCM_PixelDataProviderURL, str);
    BOOST_CHECK(cond.good());
    BOOST_CHECK_EQUAL(str, "abcde");
}

BOOST_AUTO_TEST_CASE(SetUT02)
{
    std::vector<dicomifier::TagAndRange> vect;
    vect.push_back(dicomifier::TagAndRange(DCM_PixelDataProviderURL,
                                           dicomifier::Range(0,2)));
